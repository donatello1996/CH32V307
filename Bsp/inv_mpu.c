...
#define i2c_write   I2C_Write_Reg_Datas_PB6_PB7
#define i2c_read    I2C_Read_Datas_PB6_PB7
...
{ 
	...
	I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_PWR_MGMT1_REG , 0X80);
  	Delay_ms(100);
	I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_PWR_MGMT1_REG , 0X00);
	MPU_Set_Gyro_Fsr(3);
	MPU_Set_Accel_Fsr(0);
	MPU_Set_Rate(50);
	I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_INT_EN_REG , 0X00);
	I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_USER_CTRL_REG , 0X00);
	I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_FIFO_EN_REG , 0X00);
	I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_INTBP_CFG_REG , 0X80);
	res = I2C_Read_Addr_PB6_PB7(MPU_ADDR , MPU_DEVICE_ID_REG);
	printf("res = 0x%x\n" , res);
	if(res == MPU_ADDR)
	{
		I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_PWR_MGMT1_REG,0X01);
		I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_PWR_MGMT2_REG,0X00);
		MPU_Set_Rate(50);
 	}
	else return 1;
	return 0;
...
{
	return I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_GYRO_CFG_REG,fsr<<3);
}

uint8_t MPU_Set_Accel_Fsr(uint8_t fsr)
{
	return I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_ACCEL_CFG_REG,fsr<<3);
}
...
uint8_t MPU_Set_LPF(uint16_t lpf)
{
	...
	return I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_CFG_REG,data);
...
uint8_t MPU_Set_Rate(uint16_t rate)
{
	...
	if(rate<4)rate=4;
	data=1000/rate-1;
	data = I2C_Write_Reg_Data_PB6_PB7(MPU_ADDR , MPU_SAMPLE_RATE_REG,data);
...
short MPU_Get_Temperature(void)
{
    ...
    short raw;
	float temp;
	I2C_Read_Datas_PB6_PB7(MPU_ADDR , MPU_TEMP_OUTH_REG , 2 , buf); 
...
{
    uint8_t buf[6],res;  
	res = I2C_Read_Datas_PB6_PB7(MPU_ADDR , MPU_GYRO_XOUTH_REG , 6 , buf);
	if(res == 0)
	{
...
{
    uint8_t buf[6],res;  
	res = I2C_Read_Datas_PB6_PB7(MPU_ADDR , MPU_ACCEL_XOUTH_REG , 6 , buf);
	if(res==0)
	{
